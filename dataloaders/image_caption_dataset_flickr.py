...
class ImageCaptionDataset(Dataset):
    def __init__(self, dataset_file, audio_conf=None, image_conf=None):
        """
        ...
        with open(dataset_file, 'r') as fp:
            fdata = fp.readlines()
        self.data = fdata
        self.image_base_path = "DAVEnet-pytorch/data/Flicker8k_Dataset"
        self.audio_base_path = "DAVEnet-pytorch/data/flickr_audio/wavs"
    ...
    def __getitem__(self, index):
        ...
        wavpath = os.path.join(self.audio_base_path, datastr[0])
        imgpath = os.path.join(self.image_base_path, datastr[1])
