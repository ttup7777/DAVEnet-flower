...
__C.cmvn = False
__C.margin = 0.5
__C.max_length = 640  # 800 for flower
...
__C.image_attention = True
__C.audio_attention = True
...
__C.IMG = edict()
__C.IMG.style = 'raw'   #npy | raw | pickle
...
__C.Loss.trip = False
__C.Loss.dist = False
__C.Loss.divers = False
__C.Loss.batch_loc = False
__C.Loss.disc = False
__C.Loss.gamma_disc = 1.0
__C.Loss.gamma_batch_loc = 1.0
__C.Loss.gamma_divers = 1.0
